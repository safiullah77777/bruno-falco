...
const PreLaunching = () => {
  return (
    <div className="pre-launching middle pt-[12rem] relative">
      <img src={scientist} alt="" className="absolute right-0 top-[16rem]" />
      <img src={moon} alt="" className="absolute -left-[15rem] bottom-[16rem]" />
      <img src={moon1} alt="" className="absolute right-[5rem] bottom-[0rem]" />
      <div className="flex flex-col max-w-[128.2rem] gap-[5rem]">
        <div className="w-full gap-[4.2rem] grid grid-cols-2">
          <div className="bg-[#272E44] rounded-[1.2474rem] w-full"></div>
          <div className="flex flex-col gap-[5.8rem] w-full">
            <h1 className="h !text-[5.2632rem] text-white">
        ...
        <div className="gradient-border1 mb-[10rem]">
          <div className="w-full flex middle gap-[1rem] py-[3.5rem] bg-gradient1">
            <p className="h text-white max-w-[83.3rem]">
