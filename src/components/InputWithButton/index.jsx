...
const InputWithButton = () => {
  return (
    <div className="relative flex bg-purple-secondary p-[1rem] rounded-[1rem] h-[6.4rem]">
      ...
      <button className="absolute right-[1rem] py-[1.35rem] px-[2rem] rounded-[.5rem] bg-gradient2 top-[1rem] font-700 text-[1.4rem] leading-121.5 tracking-[1.68px] uppercase text-blue-primary">
        Keep me updated
      </button>
    </div>
  );
